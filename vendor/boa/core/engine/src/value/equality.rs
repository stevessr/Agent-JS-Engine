...
impl JsValue {
    ...
    pub fn equals(&self, other: &Self, context: &mut Context) -> JsResult<bool> {
        ...
        Ok(match (self.variant(), other.variant()) {
            ...
            // Annex B `[[IsHTMLDDA]]` special cases for abstract equality.
            (JsVariant::Object(object), JsVariant::Null | JsVariant::Undefined)
            | (JsVariant::Null | JsVariant::Undefined, JsVariant::Object(object)) => {
                object.is_html_dda()
            }
